...
export default function SnakeGame() {
  ...
  // clavier (empêche le scroll des flèches)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      setSnake(sn => {
        ...
        // auto-collision (ignore la dernière case si on ne mange pas)
        ...
        if (!eat) {
          ...
          setScore(s => s + 1);
          // nouvelle nourriture sur case libre
  ...
  return (
    <main className="px-6 py-20 text-white">
      <div ref={wrapRef} tabIndex={0} className="mx-auto max-w-fit outline-none" aria-label="Surface de jeu Snake">
